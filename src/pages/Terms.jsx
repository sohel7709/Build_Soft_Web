    ...
    <section className="page-container">
      <div className="container">
        ...
        <p>
          ...
          https://buildsoftit.com (&#39;Website&#39;), including the related mobile site
          and mobile application (hereinafter referred to as &#39;Platform&#39;).
        </p>
        <p>
          The Platform is owned by BUILDSOFT IT SOLUTIONS PRIVATE LIMITED, a
          company incorporated under the Companies Act, 1956 with its
          registered office at Near Z P School, Osmannagar , Loha ,Nanded
        ...
        <ol>
          ...
          <li>
            ...
            be subject to the exclusive jurisdiction of the courts in Nanded and
            Maharashtra .
          </li>
          <li>
